...
public class Application {
    ...
    public static Consumer<String, Transaction> createKafkaConsumer(String bootstrapServers, String consumerGroup) {
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, /** Complete el codigo aca en caso que sea necesario **/);
        properties.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, /** Complete el codigo aca en caso que sea necesario **/);
        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, /** Complete el codigo aca en caso que sea necesario **/);
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, /** Complete el codigo aca en caso que sea necesario **/);
